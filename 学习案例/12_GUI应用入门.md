# EasyXT第十课：EasyXT GUI 入门应用教程

---

> **来源**：王者quant

> **链接**：https://mp.weixin.qq.com/s/f4pjjULaKdTnVY0eaG_VNg

> **保存时间**：2026/7/7 15:40:35
...
本教程基于 学习实例/10_GUI应用入门.py，目的为掌握 gui_app 下各模块的用途、依赖检查，以及如何启动主GUI、简洁交易界面与回测窗口。
