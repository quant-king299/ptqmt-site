...
> **链接**：https://mp.weixin.qq.com/s/5Z1tAUQn7SmWHi_ANp-49A

> **保存时间**：2026/7/7 15:40:41
...
classLiveTradingStrategy:
 """实盘交易策略类（无时间限制版）"""
 
 def__init__(self, userdata_path, account_id):
 """初始化策略"""
...
: strategies/ 目录
**前置课程**
: 01_基础入门.py, 02_交易基础.py, 03_高级交易.py
